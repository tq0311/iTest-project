<template>
	<div class="organ-management">
		<div class="result-card">
			<div class="card-top">机构列表</div>
			<div class="content">
				<div class="table-list">
					...
					<el-dialog title="添加任务--机构管理" :visible.sync="dialogFormVisible" :modal="false" :close-on-click-modal="false" :lock-scroll="true">
						<el-form :model="form">
					...
					<el-dialog title="修改任务--机构管理" :visible.sync="dialogFormVisible1" :modal="false" :close-on-click-modal="false" :lock-scroll="true">
							<el-form :model="form1">
								<el-form-item label="短信通知对象" :label-width="formLabelWidth">
	...
	export default {
		...
		methods: {
			...
			search () {
				...
				this.axios.post(`${this.url}/safety/institutions`)
...
<style>
	.organ-management .content{
		height: 100%;
		width: 100%;
		padding: 1px;
	}
	.organ-management .card-content table{
		margin-top: 10px;
		width: 100%;
	}
	.organ-management .card-content table tr th{
		width: 100px;
		height: 32px;
		padding: 1px 0;
		text-align: right;
	}
	.organ-management .card-content table tr td{
		text-align: left;
		height: 34px;
		padding: 1px 0 1px 5px;
		line-height: 32px;
	}
	.organ-management .export{
		height: 31px;
		padding-left: 5px;
		border-bottom: 1px solid #ddd;
		background-color: #f4f4f4;
	}
	.organ-management .icon{
		padding-left: 2px;
		float: left;
		width: 78px;
		height: 26px;
